...
var pushMissingMsg = fs.readFileSync(
  path.resolve(__dirname, "../template/startup/pushMissingMsg.js"),
  "utf8"
);
var missingError = fs.readFileSync(
  path.resolve(__dirname, "../template/startup/missingError.js"),
  "utf8"
);
    ...
    indent([
      ...
      indent([
        ...
        indent([
          ...
          indent([
            ...
            indent([
              ...
              "case \"this\":",
              "case \"window\":",
              indent(["if(window[item.name]){ continue; }", "break;"]),
              "case \"global\":",
              indent(["if(global[item.name]){ continue; }", "break;"]),
              "default:",
              indent([enableLog ? libraryTargetWarn : "", "continue;"])
            ]),
            "}"
          ]),
          "}",
        ...
        indent([
          ...
          indent(["if(++retrySuccessed == missing.length){ check(); }"]),
          "});"
        ]),
        "}"
      ]),
